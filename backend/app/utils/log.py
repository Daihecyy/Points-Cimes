    ...
    def get_config_dict(self, settings: Settings):
        ...
        return {
            ...
            "loggers": {
                ...
                # points-cimes.error should be used to log all errors which does not correspond to one of the specific loggers
                ...
                # We disable "uvicorn.access" to replace it with our custom "points-cimes.access" which add custom information like the request_id
